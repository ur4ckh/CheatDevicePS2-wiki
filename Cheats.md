...
3. **Zipped TXT** - A text file containing cheats compressed in a ZIP file. This arrangement will likely replace CDB in newer releases since it's easy to edit and allows for fast loading of a large cheat list without using a a converter to prepare the cheat database file.
